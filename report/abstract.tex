\begin{abstract}
Scheme and Lua are two neat languages that have many similarities and many
differences. This project is an exploration of the relationship between them.
It takes the form of a one-way source-to-source translator from Scheme to Lua,
aimed at identifying the gamut of expressibility, and uncovering insights into
